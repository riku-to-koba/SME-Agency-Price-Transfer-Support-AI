...
## このステップで推奨されるツール
- `search_knowledge_base`: 取引条件確認のベストプラクティスを検索
- `generate_diagram`: 業務フローの可視化
""",
...
## このステップで推奨されるツール
- `search_knowledge_base`: 原価計算の手順と方法を検索
- `calculator`: 原価計算のシミュレーション
- `generate_diagram`: 原価構造の可視化（円グラフ、棒グラフ）
""",
...
## このステップで推奨されるツール
- `search_knowledge_base`: 見積書フォーマットのベストプラクティスを検索
""",
